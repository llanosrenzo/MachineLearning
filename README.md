...
$${{\frac{\partial S}{\partial \beta_0}|}_{\hat{\beta}_0 \hat{\beta}_1}} = -2\sum_{i=1}^{n}$$


$${\frac{\partial S}{\partial \beta_0}|}_{\hat{\beta}_0  \hat{\beta}_1} = -2\sum_{i=1}^{n}(y_i - \hat{\beta}_0 - \hat{\beta}_1x_i) = 0$$
